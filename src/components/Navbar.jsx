...
function Navbar({ onSearch }) {
  return (
    <nav className="bg-gray-800 border-b-2 px-5 sm:px-24 py-5">
      <div className="container flex flex-wrap justify-between items-center mx-auto gap-5 sm:gap-0">
        <a href="/" className="flex items-center">
          <span className="self-center text-white text-3xl font-bold whitespace-nowrap uppercase">Notes</span>
        </a>
